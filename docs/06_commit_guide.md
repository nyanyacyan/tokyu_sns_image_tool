...
作業内容をコミットする前に、以下の項目を確認しましょう

- [ ] ステータス（[Add] や [Fix] など）を先頭に書いた
- [ ] 1〜2行で「何をしたのか」が伝わる文章にした
- [ ] 内容が「変更」「修正」などのあいまいな表現になっていない
- [ ] もし作業中なら [WIP] をつけた（未完成でも安心して共有できる）
- [ ] 1つのコミットに詰め込みすぎていない（内容ごとに分けられる？）
